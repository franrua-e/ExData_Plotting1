...
plot(as.numeric(subset_df$Sub_metering_1) ~ subset_df$DateTime, type="l", 
     ylab="Energy sub metering", xlab="")
lines(subset_df$Sub_metering_2~subset_df$DateTime,col='Red')
lines(subset_df$Sub_metering_3~subset_df$DateTime,col='Blue')
